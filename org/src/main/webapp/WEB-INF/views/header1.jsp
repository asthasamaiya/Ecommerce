...
.banner {
    min-height: 455px;
    background: url(file:///D:/Temp/org23/src/main/webapp/images/b1.jpg) no-repeat center 0px;
    }
	.w3l_logo h1 a span {
    display: block;
    font-size: .3em;
	...
	<div class="header" id="home1">
		<div class="container">
			<div style="margin-left: -2em;">
				<a href="list5" class="button" >Login</a>
			...
			<div class="cart cart box_1">
				<a href="list4" style="color:white; line-height:37px;" class="w3view-cart">Cart</a>
			</div>  
		</div>
