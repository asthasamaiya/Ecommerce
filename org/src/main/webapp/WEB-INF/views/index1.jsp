			...
			<div class="col-md-7 wthree_banner_bottom_right">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<ul id="myTab" class="nav nav-tabs" role="tablist">
						...
						<li role="presentation"><a href="#audio" role="tab" id="audio-tab" data-toggle="tab" aria-controls="audio">Earphones</a></li>
						<li role="presentation"><a href="#video" role="tab" id="video-tab" data-toggle="tab" aria-controls="video">Charger</a></li>
						<li role="presentation"><a href="#tv" role="tab" id="tv-tab" data-toggle="tab" aria-controls="tv">Power Bank</a></li>
						<li role="presentation"><a href="#kitchen" role="tab" id="kitchen-tab" data-toggle="tab" aria-controls="kitchen">Covers</a></li>
					</ul>
						...
						<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
							<div class="agile_ecommerce_tabs">
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="single.jsp">Xiaomi mi5</a></h5>
									<div class="simpleCart_shelfItem">
										<p> <i class="item_price">Rs.13000</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
			...
			<div class="agileinfo_new_products_grids">
					...
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<div class="simpleCart_shelfItem">
							...
							<form action="products.jsp" method="post">
								...
								<button type="submit" class="w3ls-cart">view phones</button>
							</form>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<h5><a href="single.jsp">Vivo Phones</a></h5>
						<div class="simpleCart_shelfItem">
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<h5><a href="single.jsp">Oppo Phones</a></h5>
						<div class="simpleCart_shelfItem">
